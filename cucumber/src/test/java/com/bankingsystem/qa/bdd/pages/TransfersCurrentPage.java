...
public class TransfersCurrentPage {
    ...
    public TransfersCurrentPage open() {
    ...
    public void waitForTransactionRowCountToIncrease(
            int previousCount
    ) {
    ...
    public void waitForCheckingBalance(
